(function () {
  ...
  var MESSAGES = {
    fr: {
      availability: "Bonjour,\nJe souhaite vérifier si l'une des 2 dernières places est toujours disponible pour le Voyage Holistique du 10 au 17 août.",
      payment: "Bonjour,\nJe souhaiterais connaître les modalités de paiement et de réservation du Voyage Holistique.",
      question: "Bonjour,\nJ'ai quelques questions avant de réserver ma place au Voyage Holistique.",
    ...
    en: {
      availability: "Hello,\nI'd like to check whether one of the last 2 spots is still available for the Holistic Journey from August 10 to 17.",
      payment: "Hello,\nI would like to know the payment and booking details for the Holistic Journey.",
      question: "Hello,\nI have a few questions before booking my spot for the Holistic Journey.",
    ...
    nl: {
      availability: "Hallo,\nIk wil graag controleren of een van de laatste 2 plaatsen nog beschikbaar is voor de Holistische Reis van 10 tot 17 augustus.",
      payment: "Hallo,\nIk zou graag de betalings- en reserveringsvoorwaarden van de Holistische Reis willen kennen.",
      question: "Hallo,\nIk heb nog een paar vragen voordat ik mijn plek reserveer voor de Holistische Reis.",
  ...
  var UI_TEXT = {
    fr: {
      ...
      opt5: "J'ai rempli le formulaire et je veux finaliser ma réservation"
    },
    en: {
      ...
      opt5: "I already filled the form, I'd like to finalize my reservation"
    },
    nl: {
      eyebrow: "WhatsApp Contact",
      ...
      opt5: "Ik heb het formulier al ingevuld en wil mijn reservering afronden"
    }
  };
  ...
  function init() {
    var modal = document.getElementById("waOptionsModal");
    if (!modal) return;

    var closeBtn = document.getElementById("waModalClose");
    var options = Array.prototype.slice.call(modal.querySelectorAll(".wa-option"));
